...
Given an operator $o$ and a sometime preference $P = \sf{ST}_{\phi}$ of a problem with preferences $P$, $o$ is a \textbf{potential support} for $P$ if $o$ can make true $\phi$ otherwise the operator is \textbf{neutral} for $P$.
\end{mydef}
