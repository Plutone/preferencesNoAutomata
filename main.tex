...
and the more recent {\lprpgp} \cite{LPRPGP-P:icaps11}
...
\;\;\;\;\;\;\text{if}\;o\;\text{is a violators for }P\\
...
$o$ affects $P$. If $o$ is a violators for $P$, then the condition is always true (i.e. it is the special literal
...
from the application of $o$. So, if all $ { \phi_i \not \in {C}_{\phi}(o)} $ hold in $s$ 
